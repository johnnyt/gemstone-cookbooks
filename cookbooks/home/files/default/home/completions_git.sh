...
complete -o default -o nospace -F _git_merge gmd
complete -o default -o nospace -F _git_stash gs
complete -o default -o nospace -F _git_stash gsl
complete -o default -o nospace -F _git_stash gsa
complete -o default -o nospace -F _git_push gctb
